...
REPO="github.com/acquisitionist/teletron" # Current library import path
GO_VERSION="1.25.1"                       # Go version we expect our samples to be using
V_MAJOR=""                            # Current major version for the library
V_DUMMY="v1.99.99"                      # dummy version for the library
